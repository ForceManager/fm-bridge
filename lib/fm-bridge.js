...
var client = {
  ...
  getLiteral: function getLiteral(literal) {
    if (!literal) return Promise.reject({
      msg: 'No literal'
    });
  ...
  getUserData: function getUserData() {
    return _postRobot.default.sendToParent('getUserData', {
      version: version
    });
  },
