...
var client = {
  getCompanyId: function getCompanyId() {
    return _postRobot.default.sendToParent('getCompanyId', {
      veresion: veresion
    });
  },
